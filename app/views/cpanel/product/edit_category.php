	...
	?> 
        <div id="content" class="fl-right">
            <div class="section" id="title-page">
                <div class="clearfix">
                    <h3 id="index" class="fl-left" style="text-align: center;">CẬP NHẬT DANH MỤC SẢN PHẨM</h3>
                </div>
            </div>
	...
	?>
     ...
     font-family: Poppins, Arial, sans-serif;">
                            <div style="width: 400px; margin-bottom: 20px;">
                                ...
                                <input type="text" value="<?php echo $cate['title_category_product'] ?>" name="title_category_product" id="title" style="display: block;width: 300px;height: 30px;border-radius: 15px; margin-bottom: 20px; margin-top: 20px;">

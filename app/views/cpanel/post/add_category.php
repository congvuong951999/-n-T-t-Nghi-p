	...
	?>
        <div id="content" class="fl-right">
            <div class="section" id="title-page">
                <div class="clearfix">
                    <h3 id="index" class="fl-left" style="text-align: center;">THÊM MỚI DANH MỤC BÀI VIẾT</h3>
                </div>
            </div>
     ...
     font-family: "Poppins", Arial, sans-serif;">
                            <div style="width: 400px; margin-bottom: 20px;">
                                ...
                                <input type="text" required name="title_category_post" id="title" style="display: block;width: 300px;height: 30px;border-radius: 15px; margin-bottom: 20px; margin-top: 20px;">

                                <label for="pwd">Miêu Tả</label>
                                 <textarea required name="desc_category_post" rows="5" id="editor" class="form-control"></textarea>

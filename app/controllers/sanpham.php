<?php 
	...
	class sanpham extends DController{
		...
		$cond = "($table_product.id_category_product=$table.id_category_product AND $table_product.title_product LIKE '%".$condd."%')";
		$categorymodel = $this->load->model('categorymodel');
		$data['category'] =$categorymodel->category_home($table);
		$data['category_post'] =$categorymodel->categorypost_home($table_post);
		$data['category_seach'] =$categorymodel->seach($table, $table_product, $cond);
